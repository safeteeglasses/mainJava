...
public class LectureTest {
    ...
    public void testReturnWhenGreaterThanFive() {
        assertTrue("We should return true when parameter is greater than five", exercises.returnTrueWhenGreaterThanFive(6));
        assertFalse("We should return false when parameter is five", exercises.returnTrueWhenGreaterThanFive(5));
        assertFalse("We should return false when parameter is smaller than five", exercises.returnTrueWhenGreaterThanFive(4));
    }

    @Test
    public void testReturnWhenGreaterThanFiveInOneLine() {
        assertTrue("We should return true when parameter is greater than five", exercises.returnTrueWhenGreaterThanFiveInOneLine(6));
        assertFalse("We should return false when parameter is five", exercises.returnTrueWhenGreaterThanFiveInOneLine(5));
        assertFalse("We should return false when parameter is smaller than five", exercises.returnTrueWhenGreaterThanFiveInOneLine(4));
    }

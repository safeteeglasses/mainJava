...
// To define one: List<datatype-to-be-stored>  name = new ArrayList<datatype-to-be-stored>();
		...
		//                 cant' stop anywhere but the end
		//                 can't skip elements)
		...
		for(String anElement : names) {  // every time through the loop anElement will be assigned an element in names			
		   System.out.println(anElement);// print the the current value from names (anElement)
		}
		...
		priorities.offer("Wash the counters");  // add an element to end
		priorities.offer("Sweep the floor");   // add an element to end
		priorities.offer("Scrub the floor");   // add an element to end

...
describe('exercises', () => {
  ...
  describe('makeHappy', () => {
    ...
    it("should put 'Happy' at the beginning of the strings", () => {
      makeHappy(['days', 'feet', 'dance']).should.deep.equal([
        'Happy days', 'Happy feet', 'Happy dance'
      ]);
    });
  });
  ...
  describe('getFullAddressOfProperties', () => {
    ...
    it('should return full addresses or property', () => {
      getFullAddressesOfProperties(properties).should.deep.equal([
        '443B Baker St Greenwich OH 44322',
        '2002 Winston Rd Tokyo OK 65434'
      ]);
    });
  });
  ...
  describe('findLargest', () => {
    ...
    it('should find the largest string (latest in the alphabet)', () => {
      findLargest(['aardvark', 'zebra', 'mongoose', 'hippo']).should.equal('zebra');
    });
  });
